...
.PHONY: help test test-linux test-rhel test-all lint lint-shell lint-ps clean
...
help:
	...
	@echo "  test          - Run state tests on all distributions"
	...
	@echo ""
	@echo "Examples:"
	@echo "  make test-rhel    # Quick RHEL test"
