...
{%- macro deploy_file(state_name, user_home, dotfile_name, source, username, creates=None) -%}
{{ state_name }}:
  file.managed:
...
{%- macro deploy_directory(state_name, user_home, dotdir_name, source, username) -%}
{{ state_name }}:
  file.recurse:
...
{%- macro deploy_symlink(state_name, user_home, link_name, target_name, username, require=None) -%}
{{ state_name }}:
  file.symlink:
