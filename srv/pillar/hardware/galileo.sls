...
packages_extra:
  arch:
    ...
    deck_tools: [alsa-ucm-conf, amd-ucode, caps, dkms, noise-suppression-for-voice, sof-firmware, steamdeck-dkms, steamdeck-dsp, steamdeck-dsp-debug, upower, vpower, ludusavi-bin, hunspell, hunspell-fr, hunspell-en_gb, hunspell-en_us,hunspell-ja]
