...
## Active
- [x] Implement brew package installation (commit dce8e11)
  - Created srv/salt/linux/brew.sls state
  - Install packages from provisioning/packages.sls brew list
  - Runs as first managed user (Homebrew rejects root)
  - Included in linux/init.sls after homebrew state
